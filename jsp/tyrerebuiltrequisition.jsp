...
<%
	String url =  request.getContextPath()+"/rebuiltrequisition.do";
%>
<html:html>
	<head>
		<title></title>
	...
	function submitdone()
	{
		...
		document.forms[0].action = "<%=request.getContextPath()%>"+"/rebuiltrequisition.do?invoke=jobMethod";	
	...
	{
		document.forms[0].method="post";
		document.forms[0].action = "<%=request.getContextPath()%>"+"/rebuiltrequisition.do?invoke=approveMethod";	
		document.forms[0].submit();
	}
	function okdone()
	{
		document.forms[0].method="post";
		document.forms[0].action = "<%=request.getContextPath()%>"+"/rebuiltrequisition.do?invoke=okMethod";	
		document.forms[0].submit();
	}
	function cleardone()
	{
		document.forms[0].method="post";
		document.forms[0].action = "<%=request.getContextPath()%>"+"/rebuiltrequisition.do?invoke=clearMethod";	
		document.forms[0].submit();
	}
	function selectTyreNumber()
	{
		document.forms[0].method="post";
		document.forms[0].action = "<%=request.getContextPath()%>"+"/rebuiltrequisition.do?invoke=tyreNumberMethod";	
		document.forms[0].submit();
	}
	function setTyreNumber1()
	{
		document.forms[0].method="post";
		document.forms[0].action = "<%=request.getContextPath()%>"+"/rebuiltrequisition.do?invoke=setTyreNumberMethod1";	
		document.forms[0].submit();
	}
	function setTyreNumber2()
	{
		document.forms[0].method="post";
		document.forms[0].action = "<%=request.getContextPath()%>"+"/rebuiltrequisition.do?invoke=setTyreNumberMethod2";	
		document.forms[0].submit();
	}
	function setTyreNumber3()
	{
		document.forms[0].method="post";
		document.forms[0].action = "<%=request.getContextPath()%>"+"/rebuiltrequisition.do?invoke=setTyreNumberMethod3";	
		document.forms[0].submit();
	}
	function setTyreNumber4()
	{
		document.forms[0].method="post";
		document.forms[0].action = "<%=request.getContextPath()%>"+"/rebuiltrequisition.do?invoke=setTyreNumberMethod4";	
		document.forms[0].submit();
	}
	function setTyreNumber5()
	{
		document.forms[0].method="post";
		document.forms[0].action = "<%=request.getContextPath()%>"+"/rebuiltrequisition.do?invoke=setTyreNumberMethod5";	
		document.forms[0].submit();
	}
	function setTyreNumber6()
	{
		document.forms[0].method="post";
		document.forms[0].action = "<%=request.getContextPath()%>"+"/rebuiltrequisition.do?invoke=setTyreNumberMethod6";	
		document.forms[0].submit();
	}
	function setTyreNumber7()
	{
		document.forms[0].method="post";
		document.forms[0].action = "<%=request.getContextPath()%>"+"/rebuiltrequisition.do?invoke=setTyreNumberMethod7";	
		document.forms[0].submit();
	}
	function setTyreNumber8()
	{
		document.forms[0].method="post";
		document.forms[0].action = "<%=request.getContextPath()%>"+"/rebuiltrequisition.do?invoke=setTyreNumberMethod8";	
		document.forms[0].submit();
	}
	function setTyreNumber9()
	{
		document.forms[0].method="post";
		document.forms[0].action = "<%=request.getContextPath()%>"+"/rebuiltrequisition.do?invoke=setTyreNumberMethod9";	
		document.forms[0].submit();
	}
	function setTyreNumber10()
	{
		document.forms[0].method="post";
		document.forms[0].action = "<%=request.getContextPath()%>"+"/rebuiltrequisition.do?invoke=setTyreNumberMethod10";	
		document.forms[0].submit();
	}
</script>

<body> 
<html:form action="rebuiltrequisition" enctype="multipart/form-data">

<table border="0" width="99%" cellspacing="7" cellpadding="7" height="609">
<tr>
    <td width="25%" colspan="3" height="55"><p align="center" class="maintitle"></td>
    <td width="9%" colspan="3" height="55"><p align="right">
	<img border="0" src="<%=request.getContextPath()%>/images/tyre rebuilt req.jpg" width="40" height="40"></td>
    <td width="66%" colspan="8" height="55" class="maintitle">TYRE REBUILT REQUISITION FORM</td>
    <td width="11%"></td>
     </tr>
  <tr> 
  ...
  <td width="1%" height="34" class="fieldname">&nbsp;</td>
    ...
    <a href="#" onClick="showCalendar(this,document.TyreRebuiltRequisitionForm.requestedDate,'dd mmm yyyy',null,1)" TITLE="cal01.select(document.TyreRebuiltRequisitionForm.requestedDate,'anchor01','dd MMM yyyy'); return false;" NAME="anchor02" ID="anchor02">
  ...
  <tr>
    ...
    <td width="12%" height="26" colspan="2" align="center"><html:text property="inchargeName" style="width:200"/></td>
	...
	<logic:present property="tyreNumberList" name="TyreRebuiltRequisitionForm">	
	<bean:define id="tyreNumberList" name="TyreRebuiltRequisitionForm" property="tyreNumberList" type="java.util.Collection" ></bean:define>
  ...
  <tr>
	...
	<logic:present property="tyrePlyList" name="TyreRebuiltRequisitionForm">	
	<bean:define id="tyrePlyList" name="TyreRebuiltRequisitionForm" property="tyrePlyList" type="java.util.Collection" ></bean:define>
  ...
  <tr>
	...
	<logic:present property="tyreSizeList" name="TyreRebuiltRequisitionForm">	
	<bean:define id="tyreSizeList" name="TyreRebuiltRequisitionForm" property="tyreSizeList" type="java.util.Collection" ></bean:define>
  ...
  <tr>
	...
	<logic:present property="tyreBrandList" name="TyreRebuiltRequisitionForm">	
	<bean:define id="tyreBrandList" name="TyreRebuiltRequisitionForm" property="tyreBrandList" type="java.util.Collection" ></bean:define>
    ...
    <td width="97%" height="215" colspan="15" align="center">
      <table border="1" width="75%">
        <tr>
          ...
          <td width="25%" align="center" class="fieldname">Tyre Brand</td>
          <td width="24%" align="center" class="fieldname">Tyre Size</td>
        ...
        <tr>
          ...
          <td width="25%" align="center">
			<p><html:text property="rebuiltNumber1" style="width:150"/></td>
          <td width="24%" align="center">
			<html:text property="rebuiltReason1" style="width:150"/></td>
        </tr>
        <tr>
          ...
          <td width="25%" align="center">
			<p><html:text property="rebuiltNumber2" style="width:150"/></td>
          <td width="24%" align="center">
			<html:text property="rebuiltReason2" style="width:150"/></td>
        </tr>
        <tr>
          ...
          <td width="25%" align="center">
			<p><html:text property="rebuiltNumber3" style="width:150"/></td>
          <td width="24%" align="center">
			<html:text property="rebuiltReason3" style="width:150"/></td>
        </tr>
        <tr>
          ...
          <td width="25%" align="center">
			<p><html:text property="rebuiltNumber4" style="width:150"/></td>
          <td width="24%" align="center">
			<html:text property="rebuiltReason4" style="width:150"/></td>
        </tr>
        <tr>
          ...
          <td width="25%" align="center">
			<p><html:text property="rebuiltNumber5" style="width:150"/></td>
          <td width="24%" align="center">
			<html:text property="rebuiltReason5" style="width:150"/></td>
        </tr>
        <tr>
          ...
          <td width="25%" align="center">
			<p><html:text property="rebuiltNumber6" style="width:150"/></td>
          <td width="24%" align="center">
			<html:text property="rebuiltReason6" style="width:150"/></td>
        </tr>
        <tr>
          ...
          <td width="25%" align="center">
			<p><html:text property="rebuiltNumber7" style="width:150"/></td>
          <td width="24%" align="center">
			<html:text property="rebuiltReason7" style="width:150"/></td>
        </tr>
        <tr>
          ...
          <td width="25%" align="center">
			<p><html:text property="rebuiltNumber8" style="width:150"/></td>
          <td width="24%" align="center">
			<html:text property="rebuiltReason8" style="width:150"/></td>
        </tr>
        <tr>
          ...
          <td width="25%" align="center">
			<p><html:text property="rebuiltNumber9" style="width:150"/></td>
          <td width="24%" align="center">
			<html:text property="rebuiltReason9" style="width:150"/></td>
        </tr>
        <tr>
          ...
          <td width="25%" align="center">
			<p><html:text property="rebuiltNumber10" style="width:150"/></td>
          <td width="24%" align="center">
			<html:text property="rebuiltReason10" style="width:150"/></td>
        </tr>
        </table>
    </td>
  </tr>
