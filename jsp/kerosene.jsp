...
<script language="JavaScript" src="<%=request.getContextPath()%>/scripts//popcalendar.js"></script>
	...
	function submitdone()
	{
		...
		document.forms[0].action = "<%=request.getContextPath()%>"+"/kerosene.do?invoke=jobMethod";	
		document.forms[0].submit();
	}
	function issuedone()
	{
		document.forms[0].method="post";
		document.forms[0].action = "<%=request.getContextPath()%>"+"/keroseneValidate.do?invoke=jobMethod";	
		document.forms[0].submit();
	}
	function approvedone()
	{
		document.forms[0].method="post";
		document.forms[0].action = "<%=request.getContextPath()%>"+"/kerosene.do?invoke=approveMethod";	
		document.forms[0].submit();
	}
	...
	{
		document.forms[0].method="post";
		document.forms[0].action = "<%=request.getContextPath()%>"+"/kerosene.do?invoke=okMethod";	
		document.forms[0].submit();
	}
	function listvehicletype()
	{
		document.forms[0].method="post";
		document.forms[0].action = "<%=request.getContextPath()%>"+"/kerosene.do?invoke=listVehicleMethod";	
		document.forms[0].submit();
	}
	function listvehiclenumber()
	{
		document.forms[0].method="post";
		document.forms[0].action = "<%=request.getContextPath()%>"+"/kerosene.do?invoke=listVehicleNumberMethod";	
		document.forms[0].submit();
	}
	function quantityupdate()
	{
		document.forms[0].method="post";
		document.forms[0].action = "<%=request.getContextPath()%>"+"/keroseneValidate.do?invoke=qtyUpdateMethod";	
		document.forms[0].submit();
	}
</script>

<body> 
<html:form action="kerosene" enctype="multipart/form-data">
...
<tr>
    ...
    <td width="17%" colspan="3" height="55" class="maintitle">
		<img border="0" src="<%=request.getContextPath()%>/images/kerosene.jpg" width="40" height="40" align="right"></td>
    <td width="51%" colspan="6" height="55" class="maintitle">KEROSENE REQUISITION FORM</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td width="15%" height="21" align="left" colspan="3">
      <html:select property="institutionName" style="width:150" onchange="javascript:listvehicletype()">
							<logic:present property="instList" name="KeroseneForm">	
								<bean:define id="instList" name="KeroseneForm" property="instList" type="java.util.Collection" ></bean:define>
    ...
    <td width="38%" height="21" align="left" colspan="4">
      <html:select property="vehicleType" style="width:150" onchange="javascript:listvehiclenumber()">
							<logic:present property="vehicleTypeList" name="KeroseneForm">	
								<bean:define id="vehicleTypeList" name="KeroseneForm" property="vehicleTypeList" type="java.util.Collection" ></bean:define>
								<html:option value="0">--Choose Institution--</html:option>
  ...
  <tr>
   ...
   <html:select property="vehicleNumber" style="width:150">
							<logic:present property="vehicleNumberList" name="KeroseneForm">	
								<bean:define id="vehicleNumberList" name="KeroseneForm" property="vehicleNumberList" type="java.util.Collection" ></bean:define>
  ...
  <tr>
    <td width="13%" height="21"></td>
    <td width="23%" height="21" align="left" colspan="3" class="fieldname"> Available Quantity</td>
    <td width="15%" height="21" align="left" colspan="3">
    <html:text property="totalAvailableQuantity" style="width:150"/></td>
    <td width="11%" height="21" align="left">&nbsp;</td>
    <td width="17%" height="21" align="left">Reason</td>
    <td width="38%" height="21" align="left" colspan="4">
    <html:select property="keroseneReason" style="width:150">
							<logic:present property="reasonList" name="KeroseneForm">	
								<bean:define id="reasonList" name="KeroseneForm" property="reasonList" type="java.util.Collection" ></bean:define>
  ...
  <tr>
    ...
    <td width="25%" height="25" colspan="3" class="fieldname">Required Quantity</td>
    <td width="15%" height="25" colspan="3">
	<html:text property="requiredQuantity" style="width:150" onblur="javascript:quantityupdate()"/></td>
    <td width="11%" height="25">&nbsp;</td>
    <td width="17%" height="25" class="fieldname">
	Current KM</td>
    <td width="38%" height="25" colspan="4">
	<html:text property="currentKm" style="width:150"/></td>
  </tr>
<tr>
    <td width="13%" height="25">&nbsp;</td>
