...
public class EquipmentAllotmentVO {
	...
	private String tyresizedesc=null;
	private String combo1code=null;
	private String combo2code=null;
	private String combo3code=null;
	private String combo4code=null;
	private String combo1desc=null;
	private String combo2desc=null;
	private String combo3desc=null;
	private String combo4desc=null;
	...
	public String getTyresizedesc() {
		return tyresizedesc;
	}
	public void setTyresizedesc(String tyresizedesc) {
		this.tyresizedesc = tyresizedesc;
	}
	...
	public String getCombo1code() {
		return combo1code;
	}
	public void setCombo1code(String combo1code) {
		this.combo1code = combo1code;
	}
	public String getCombo1desc() {
		return combo1desc;
	}
	public void setCombo1desc(String combo1desc) {
		this.combo1desc = combo1desc;
	}
	...
	public String getCombo2code() {
		return combo2code;
	}
	public void setCombo2code(String combo2code) {
		this.combo2code = combo2code;
	}
	public String getCombo2desc() {
		return combo2desc;
	}
	public void setCombo2desc(String combo2desc) {
		this.combo2desc = combo2desc;
	}
	...
	public String getCombo3code() {
		return combo3code;
	}
	public void setCombo3code(String combo3code) {
		this.combo3code = combo3code;
	}
	public String getCombo3desc() {
		return combo3desc;
	}
	public void setCombo3desc(String combo3desc) {
		this.combo3desc = combo3desc;
	}
	...
	public String getCombo4code() {
		return combo4code;
	}
	public void setCombo4code(String combo4code) {
		this.combo4code = combo4code;
	}
	public String getCombo4desc() {
		return combo4desc;
	}
	public void setCombo4desc(String combo4desc) {
		this.combo4desc = combo4desc;
	}
