...
public class TyreRebuiltDAO {
	
private static final Logger logger=(Logger)Logger.getLogger(TyreRebuiltDAO.class);
	...
	{   
		...
		tyreSizeList=db.selectQuery("com.vo.TyreRebuiltVO", query);
		return tyreSizeList;
	 }
	...
	{   
		...
		tyreBrandList=db.selectQuery("com.vo.TyreRebuiltVO", query);
	...
	{   
		...
		tyrePlyList=db.selectQuery("com.vo.TyreRebuiltVO", query);
		return tyrePlyList;
	 }
	...
	{   
		...
		tyreNumberList=db.selectQuery("com.vo.TyreRebuiltVO", query);
	...
	public ArrayList fetchTyreDetails(String query) {
		...
		tyreDetailsList=db.selectQuery("com.vo.TyreRebuiltVO", query);
	...
	public ArrayList fetchMinJobid(String query) {
		...
		jobidList=db.selectQuery("com.vo.TyreRebuiltVO", query);
		return jobidList;
	}
	...
	public ArrayList retrievecommontyredetails(String query) {
	 ...
	 commondetailslist=db.selectQuery("com.vo.TyreRebuiltVO",query);
