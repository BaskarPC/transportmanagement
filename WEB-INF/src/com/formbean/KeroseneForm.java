...
public class KeroseneForm extends GeneralForm{
private static final Logger logger=(Logger)Logger.getLogger(KeroseneForm.class);
	private ArrayList reasonList;
	private String totalAvailableQuantity;
	private String keroseneReason;
...
//			 Only need crossfield validations here 
			...
			if ((StringUtils.isAlpha(currentKm)||!StringUtils.isNumeric(currentKm))&& StringUtils.isNotEmpty(currentKm)) { 
				errors.add(ActionErrors.GLOBAL_MESSAGE,new ActionMessage("error.kerosenecurrentKm.required")); 
				} 
