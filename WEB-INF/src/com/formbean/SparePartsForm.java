...
public class SparePartsForm extends ValidatorForm{
private static final Logger logger=(Logger)Logger.getLogger(SparePartsForm.class);
	...
	private ArrayList partList6;
	private ArrayList partList7;
	private ArrayList partList8;
	private ArrayList partList9;
	private ArrayList partList10;
	...
	private String partNumber1=null;
	private String partNumber2=null;
	private String partNumber3=null;
	private String partNumber4=null;
	private String partNumber5=null;
	private String partNumber6=null;
	private String partNumber7=null;
	private String partNumber8=null;
	private String partNumber9=null;
	private String partNumber10=null;
	...
	private String neededSpares=null;
	/**
	...
	/**
	 * @return the partList10
	 */
	public ArrayList getPartList10() {
		return partList10;
	}
	/**
	 * @param partList10 the partList10 to set
	 */
	public void setPartList10(ArrayList partList10) {
		this.partList10 = partList10;
	}
	/**
	...
	/**
	 * @return the partList6
	 */
	public ArrayList getPartList6() {
		return partList6;
	}
	/**
	 * @param partList6 the partList6 to set
	 */
	public void setPartList6(ArrayList partList6) {
		this.partList6 = partList6;
	}
	/**
	 * @return the partList7
	 */
	public ArrayList getPartList7() {
		return partList7;
	}
	/**
	 * @param partList7 the partList7 to set
	 */
	public void setPartList7(ArrayList partList7) {
		this.partList7 = partList7;
	}
	/**
	 * @return the partList8
	 */
	public ArrayList getPartList8() {
		return partList8;
	}
	/**
	 * @param partList8 the partList8 to set
	 */
	public void setPartList8(ArrayList partList8) {
		this.partList8 = partList8;
	}
	/**
	 * @return the partList9
	 */
	public ArrayList getPartList9() {
		return partList9;
	}
	/**
	 * @param partList9 the partList9 to set
	 */
	public void setPartList9(ArrayList partList9) {
		this.partList9 = partList9;
	}
	/**
	 * @return the typeList
	 */
...
//			 Only need crossfield validations here 
			if(StringUtils.isEmpty(driverName))
			 ...
			 if((StringUtils.isAlpha(wantedQuantity1)||!StringUtils.isNumeric(wantedQuantity1))&& StringUtils.isNotEmpty(wantedQuantity1))
			 {
				 errors.add(ActionErrors.GLOBAL_MESSAGE,new ActionMessage("error.wantedQuantity1.required")); 
			 }
			if ((StringUtils.isAlpha(wantedQuantity2)||!StringUtils.isNumeric(wantedQuantity2))&& StringUtils.isNotEmpty(wantedQuantity2)) { 
				errors.add(ActionErrors.GLOBAL_MESSAGE,new ActionMessage("error.wantedQuantity2.required")); 
				} 
			
			if ((StringUtils.isAlpha(wantedQuantity3)||!StringUtils.isNumeric(wantedQuantity3))&& StringUtils.isNotEmpty(wantedQuantity3)) { 
				errors.add(ActionErrors.GLOBAL_MESSAGE,new ActionMessage("error.wantedQuantity3.required")); 
				} 
			if((StringUtils.isAlpha(wantedQuantity4)||!StringUtils.isNumeric(wantedQuantity4))&& StringUtils.isNotEmpty(wantedQuantity4))
			 {
				 errors.add(ActionErrors.GLOBAL_MESSAGE,new ActionMessage("error.wantedQuantity4.required")); 
			 }
			if ((StringUtils.isAlpha(wantedQuantity5)||!StringUtils.isNumeric(wantedQuantity5))&& StringUtils.isNotEmpty(wantedQuantity5)) { 
				errors.add(ActionErrors.GLOBAL_MESSAGE,new ActionMessage("error.wantedQuantity5.required")); 
				} 
			
			if ((StringUtils.isAlpha(wantedQuantity6)||!StringUtils.isNumeric(wantedQuantity6))&& StringUtils.isNotEmpty(wantedQuantity6)) { 
				errors.add(ActionErrors.GLOBAL_MESSAGE,new ActionMessage("error.wantedQuantity6.required")); 
				} 
			if((StringUtils.isAlpha(wantedQuantity7)||!StringUtils.isNumeric(wantedQuantity7))&& StringUtils.isNotEmpty(wantedQuantity7))
			 {
				 errors.add(ActionErrors.GLOBAL_MESSAGE,new ActionMessage("error.wantedQuantity7.required")); 
			 }
			if ((StringUtils.isAlpha(wantedQuantity8)||!StringUtils.isNumeric(wantedQuantity8))&& StringUtils.isNotEmpty(wantedQuantity8)) { 
				errors.add(ActionErrors.GLOBAL_MESSAGE,new ActionMessage("error.wantedQuantity8.required")); 
				} 
			
			if ((StringUtils.isAlpha(wantedQuantity9)||!StringUtils.isNumeric(wantedQuantity9))&& StringUtils.isNotEmpty(wantedQuantity9)) { 
				errors.add(ActionErrors.GLOBAL_MESSAGE,new ActionMessage("error.wantedQuantity9.required")); 
				} 
			if ((StringUtils.isAlpha(wantedQuantity10)||!StringUtils.isNumeric(wantedQuantity10))&& StringUtils.isNotEmpty(wantedQuantity10)) { 
				errors.add(ActionErrors.GLOBAL_MESSAGE,new ActionMessage("error.wantedQuantity10.required")); 
				} 
	 ...
	 */
	public ArrayList getItemTypeList() {
		return itemTypeList;
	}
	/**
	 * @param itemTypeList the itemTypeList to set
	 */
	public void setItemTypeList(ArrayList itemTypeList) {
