...
import com.action.TyreRebuiltRequisitionAction;
public class TyreRebuiltRequisitionForm extends ValidatorForm{
	private static final Logger logger=(Logger)Logger.getLogger(TyreRebuiltRequisitionForm.class);
