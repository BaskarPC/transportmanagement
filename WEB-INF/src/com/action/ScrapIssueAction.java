...
import com.formbean.ScrapIssueForm;
//import com.wf.*;




public class ScrapIssueAction extends BaseDispatchAction{
	private static final Logger logger=(Logger)Logger.getLogger(ScrapIssueAction.class);
	//job jb=new job();
	public ActionForward defaultMethod(ActionMapping mapping,
		...
		//ScrapIssueForm sf=(ScrapIssueForm)form;
