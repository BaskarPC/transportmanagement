...
import com.formbean.GeneralNotePurchaseForm;
public class GeneralNotePurchaseAction extends BaseDispatchAction{
	private static final Logger logger=(Logger)Logger.getLogger(GeneralNotePurchaseAction.class);
	//job jb=new job();
	public ActionForward defaultMethod(ActionMapping mapping,
			...
			//GeneralNoteForm sf=(GeneralNoteForm)form;
			String ss1=mapping.getName();
			logger.debug("GeneralNotePurchaseAction: defaultMethod<-------------"+ss1);
			logger.debug("calling job "+mapping.getName());	
			logger.debug("GeneralNotePurchaseAction:defaultMethod---------->");
