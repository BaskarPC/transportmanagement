...
import com.formbean.ServiceReqForm;
//import com.wf.*;




public class ServiceReqAction extends BaseDispatchAction{
	private static final Logger logger=(Logger)Logger.getLogger(ServiceReqAction.class);
	//job jb=new job();
	public ActionForward defaultMethod(ActionMapping mapping,
		...
		//ServiceReqForm sf=(ServiceReqForm)form;
