...
import com.formbean.GeneralNoteRequisitionForm;

//import com.wf.*;


public class GeneralNoteRequisitionAction extends BaseDispatchAction{
	private static final Logger logger=(Logger)Logger.getLogger(GeneralNoteRequisitionAction.class);
	//job jb=new job();
	public ActionForward defaultMethod(ActionMapping mapping,
		...
		GeneralNoteRequisitionForm sf=(GeneralNoteRequisitionForm)form;
